...
/// <summary>
/// Stores information about the Layour of the Prospector mine.
/// </summary>
[System.Serializable]
...
public class JsonLayoutSlot : ISerializationCallbackReceiver
{
    ...
    public class JsonLayoutPile
    {
        public int x, y;
        public string layer;
        public float xStagger; // xStagger fans cards to the side for thr draw pile
    }

    public class JsonParseLayout : MonoBehaviour
    {
        public static JsonParseLayout S
        {
            get; private set;
        }
