...
/// use it. It includes a UnityEvent completionEvent that is invoke when the
...
public class BezierMover : MonoBehaviour
{
    ...
    /// jump to the 0th point in the pts list and wait until timeS to being
    /// moving. If timeS is set to the default 0 value, then timeS will be set
    /// to Time.time (the currect time).
    /// </summary>
    public void Init(List<Vector3> pts, float timeD = 1, float timeS = 0)
    {
        // Noe the use of paramet default values for timeD & timeS
    ...
    /// that accepts Vector2 overload method to initialize the movment of this
    ...
    /// <para>world affects the transform.postions,</para>
