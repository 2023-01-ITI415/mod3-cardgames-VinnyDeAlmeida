...
// For gold and silver cards, you would add mindGold and mineSilver to this enum
...
public class ScoreManager : MonoBehaviour
{
    ...
    void Tally(eScoreEvent evt)
    {
        ...
        switch (evt)
        {
            case eScoreEvent.gameWin:
                ...
                // static fields are NOT reset by Scene.Manager.LoadScene()
    ...
    /// <summary>
    /// If the public bool checkToResetHighScoreis checked in th Editor, then
    ...
    void FloatingScoreHandler(eScoreEvent evt)
    {
        ...
        switch (evt)
        {
            case eScoreEvent.mine: // Remove a mine card
                ...
                // Get the current mourePosition in Canvas anchor coordinates
                Vector2 mousePos = Input.mousePosition;
                mousePos.x /= Screen.width;
                mousePos.y /= Screen.height;

                // Mak Bezier point to move fs from mousePos to fsPosRun
                ...
                // If this is the fist FloatingScore in this run
